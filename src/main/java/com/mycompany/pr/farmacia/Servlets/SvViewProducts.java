 ...
 * @author Nicolas
 */
@WebServlet(name = "SvViewProducts", urlPatterns = {"/SvViewProducts"})
public class SvViewProducts extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        httpSession.setAttribute("productsList", productsList);
