                        ...
                        <form action="SvEditProduct" method="POST">
                            <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                                <div class="sm:col-span-2">
                                    ...
                                    <input type="text" name="newCode" id="newCode" value="<%= productEdit.getCode()%>" class="bg-gray-50 border border-gray-300 text-gray-900 text-base rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Código del producto" required="">
                                </div>
                                <div class="sm:col-span-2">
                                    <label for="name" class="block mb-2 text-base font-medium text-gray-900 dark:text-white">Nombre</label>
                                    <input type="text" name="newName" id="newName" value="<%= productEdit.getName()%>" class="bg-gray-50 border border-gray-300 text-gray-900 text-base rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Escribe el nombre del producto" required="">
                                </div>
                                <div class="w-full">
                                    <label for="brand" class="block mb-2 text-base font-medium text-gray-900 dark:text-white">Marca</label>
                                    <input type="text" name="newBrand" id="newBrand" value="<%= productEdit.getBrand()%>" class="bg-gray-50 border border-gray-300 text-gray-900 text-base rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Marca del producto" required="">
                                </div>
                                <div class="w-full">
                                ...
                                <div>
                                    ...
                                    <input type="number" name="newStock" value="<%= productEdit.getStock()%>" id="newStock" class="bg-gray-50 border border-gray-300 text-gray-900 text-base rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="199" required="">
                                </div> 
                                <div class="sm:col-span-2">
                                    <label for="description" class="block mb-2 text-base font-medium text-gray-900 dark:text-white">Descripción</label>
                                    <textarea id="newDescription" name="newDescription" rows="8" class="block p-2.5 w-full text-base text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="La descripcion acá"><%= productEdit.getDescription()%></textarea>
                                </div>
                            </div>
                            <button type="submit" class="inline-flex text-base text-white bg-green-600 hover:bg-green-700 font-medium items-center px-5 py-2.5 mt-4 sm:mt-6 text-sm font-medium text-center text-white bg-primary-700 rounded-lg focus:ring-4 focus:ring-primary-200 dark:focus:ring-primary-900 hover:bg-primary-800">
                                Editar producto
                            </button>
                        </form>
                    </div>
