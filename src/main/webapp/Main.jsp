    ...
    <body class="flex flex-col min-h-screen bg-gray-100">
        <div class="flex-grow flex items-center justify-center">
            <div class="text-center">
                ...
                <div class="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0">
                    ...
                    <a href="Login.jsp" class="py-3 px-5 sm:ms-4 text-sm font-medium ml-4 text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
                        Iniciar sesión
                    </a>  
                </div>
            </div>
        ...
        <footer class="bg-blue-700 w-full py-4">
            <div class="w-full text-center">
                <h2 class="text-white text-sm">Todos los derechos reservados &copy; 2024</h2>
            </div>
        </footer>
    </body>
</html>
