            ...
            <div class="bg-whitedark:bg-gray-900">
                <div class="p-4 mx-auto max-w-screen-xl">
                    <div class="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-8 md:p-12 mb-8">
                        ...
                        <p class="text-base font-normal text-gray-500 dark:text-gray-400 mb-6">Tienes un total de <strong><%= productController.getAmountOfProductsController()%></strong> productos disponibles.</p>
                    ...
                    <div class="grid md:grid-cols-2 gap-8">
                        ...
                        <div class="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-8 md:p-12">
                            ...
                            <p class="text-base font-normal text-gray-500 dark:text-gray-400 mb-4">Haz realizado un total de <strong>117</strong> compras en el ultimo mes.</p>
                            <a href="#" class="inline-flex justify-center items-center py-2.5 px-5 text-base font-medium text-center text-white rounded-lg bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900">
                    ...
                    <div class="grid mt-8 md:grid-cols-2 gap-8">
                        <div class="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-8 md:p-12">
                            ...
                            <p class="text-base font-normal text-gray-500 dark:text-gray-400 mb-4">En la actualidad, tienes un total de <strong>1409</strong> empleados que forman parte de tu equipo.</p>
                            <a href="#" class="inline-flex justify-center items-center py-2.5 px-5 text-base font-medium text-center text-white rounded-lg bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900">
                        ...
                        <div class="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-8 md:p-12">
                            ...
                            <p class="text-base font-normal text-gray-500 dark:text-gray-400 mb-4">Actualmente, cuentas con un total de <strong>109</strong> clientes registrados en tu base de datos.</p>
                            <a href="#" class="inline-flex justify-center items-center py-2.5 px-5 text-base font-medium text-center text-white rounded-lg bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900">
