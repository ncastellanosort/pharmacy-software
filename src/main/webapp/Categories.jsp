        ...
        <section class="p-4 sm:ml-48">
            <div class="bg-whitedark:bg-gray-900 p-4">
                ...
                <div class="flex flex-row justify-between items-center p-8 md:p-12 bg-gray-50 border border-gray-200 rounded-lg overflow-hidden">
                    ...
                    <h1 class="text-3xl text-gray-900 md:text-5xl font-extrabold tracking-tight leading-none text-black dark:text-white">Categorías</h1>

                    <button type="submit" class="text-white inline-flex items-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                        <a href="CreateCategory.jsp" class="text-base">Agregar una nueva categoría</a>
